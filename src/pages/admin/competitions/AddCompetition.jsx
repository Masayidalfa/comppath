  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        navigate("/competition"); // Redirect ke halaman competition
      } else {
    ...
    <Fragment>
      <div className="mt-10 bg-white p-10 shadow-md rounded-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* ini harusnya auto dengan user/admin yang menambahkan nya untuk sekarang seperti ini dlu aja */}
          {/* Penyelenggara */}
          <div className="mb-4">
            <label
              htmlFor="creator_id"
            ...
            <input
              ...
              onChange={(e) =>
                setCompetition({ ...competition, creator_id: e.target.value })
              }
              required
            />
          </div>
